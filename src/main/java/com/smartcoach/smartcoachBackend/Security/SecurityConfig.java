...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/api/objetivorutina/crear","/api/grupomuscular/crear","/api/unidadmetrica/libre","/api/valorevaluacionfisica/libre","/api/restriccionmedica/libre","/api/usuariocliente/crearRutina/{id}").permitAll()
